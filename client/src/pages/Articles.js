...
const Articles = () => {
  ...
  return (
    <>
      ...
      <Container maxWidth="lg" sx={{ padding: '2rem 0', backgroundColor: '#fefbf5', borderRadius: 2 }}>
            ...
            <Grid item xs={12} sm={6} md={4} key={article._id}>
              <Card sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
                <CardMedia
                  component="img"
                  height="200"
                  image={article.image || '/images/default.jpg'}  // Fallback to a default image if no image provided
                  alt={article.title}
                />
                ...
                <Box sx={{ padding: '0 1rem 1rem' }}>
                  <Button
                    ...
                    variant="contained"
                    sx={{ backgroundColor: '#f57c00', color: '#fff', '&:hover': { backgroundColor: '#ff9800' } }}
                    fullWidth
                  >
                    Read More
                  </Button>
